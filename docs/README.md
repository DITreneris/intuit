...
| [DESIGN-SYSTEM.md](DESIGN-SYSTEM.md) | DS v1.5: Tailwind tokenai, CTA, kortelių akcentas (ikona neprivaloma), `--ds-*`, TrustedBy juosta, Proof brand (`logo-pattern-inverse.jpg`), anti-patterns, checklist | Keičiasi vizualinė sistema, nauji UI primitive ar tokenai |
