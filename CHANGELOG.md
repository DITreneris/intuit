...
- **Nav / dokumentacija — sinchronas su Proof pašalinimu:** [`Header.astro`](src/components/Header.astro) — trys sekcijų anchor (`#solution`, `#process`, `#offers`); atnaujinta [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md) (M ID perskirstymas be diagramos Must), [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md), [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md).
- **Landing — pašalintos sekcijos Problema ir Chaos vs system:** [`LandingPage.astro`](src/components/LandingPage.astro) neberenderina šių blokų (komponentų failai pašalinti); [`Header.astro`](src/components/Header.astro) — nav nuo `#solution`; i18n [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — išmesti `problem`, `chaosVsSystem`, `nav.problem`. Sinchronizuota: [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md), [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md), [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md), [`.cursor/rules/intuit-landing.mdc`](.cursor/rules/intuit-landing.mdc), [`src/styles/global.css`](src/styles/global.css).
...
- **Nav — premium juosta (kompaktiškos etiketės):** [`src/components/Header.astro`](src/components/Header.astro) — anchor nuorodos į `#solution`, `#process`, `#offers` (be `#about`, be `#problem`). i18n [`src/i18n/lt.ts`](src/i18n/lt.ts): `nav.solution` **Metodas**, `nav.offers` **Planai**; [`src/i18n/en.ts`](src/i18n/en.ts): **Method**, **Plans**. *(Vėliau: Proof/`nav.proof` pašalinti — žr. [Unreleased] Removed.)* [docs/COPY-GLOSSARY.md](docs/COPY-GLOSSARY.md) §6.
