...
**Minimalus plotis 320 px:** patikrinti, ar nėra horizontalaus puslapio slankiklio (`overflow-x`) ir ar hero / TrustedBy lieka naudojamos.
...
| Rankinis | Kalbos jungiklis, `mailto:` / `tel:`, TrustedBy logotipų tinklas |
...
| M7 | Sekcijos `scroll-mt-28` lipniam headeriui | OK | Sekcijų failai |
| M8 | Kontrastas ant `bg-ink` (nuorodos `text-white/75` ir kt.) | **Stebėti** paleidus — patvirtinti axe / kontrasto skaičiuokle prie `#0a0a0a` | FinalCta |
