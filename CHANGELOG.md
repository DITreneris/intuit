...
- **DS — tipografijos utilitos:** [`src/styles/global.css`](src/styles/global.css) — **`.section-intro`** (įžanga po H2), **`.card-title`** (kortelės / proceso žingsnio / paketo pavadinimas).
...
- **Landing — vizualinis balansas (auditas → DS):** [`TrustedBy.astro`](src/components/sections/TrustedBy.astro) — fiksuoti logo slotai (`h-16 w-40`), `rounded-xl` + subtilus rėmelis, **`max-h-10`**, **`opacity` + `grayscale`** su **`group-hover`** atstatymu, vienodas **`gap-6`**; [`Process.astro`](src/components/sections/Process.astro) — **outline** žingsnių numeriai, pašalintas desktop horizontalaus connectoriaus sluoksnis, **`border-l border-accent/25`** mobile, **`card card-brand`**; [`Solution.astro`](src/components/sections/Solution.astro), [`Offers.astro`](src/components/sections/Offers.astro) — **`card-brand`**, H2 mikrojuosta (`h-px w-12 bg-accent/20`); [`Offers.astro`](src/components/sections/Offers.astro) — header **`border-b`**, **`mt-8`** sąrašui, mažesnis kainos badge (`text-2xs`), antrinis CTA be custom accent hover; [`About.astro`](src/components/sections/About.astro) — H2 mikrojuosta; [`global.css`](src/styles/global.css) — **`.card-brand`** (viršutinė accent juosta), **`.card-featured`** švelnesnis lift / ring / `overflow-hidden`; [`BrandPatternPanel.astro`](src/components/BrandPatternPanel.astro) + [`tailwind.config.mjs`](tailwind.config.mjs) — švelnesnis inverse panelis (`heroInkFrom` / `heroInkTo`, ring, inset, nuotraukos `opacity`, apatinis gradientas). Dokumentacija: [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md).
- **Header — be sekcijų anchor:** [`Header.astro`](src/components/Header.astro) — pašalintos desktop ir mobile nuorodos į `#solution` / `#process` / `#offers`; mobilusis „Meniu“ (`<details>`) panaikintas — primary CTA rodomas tiesiai juostoje. i18n [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — pašalinti `nav.solution`, `nav.process`, `nav.offers`. Dokumentacija: [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md) §6, [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md).
- **Landing — mikrodizainas (shell, šešėliai, DS):** [`src/styles/global.css`](src/styles/global.css) — `.section-shell` vertikalus padding **`lg:py-24`**; [`tailwind.config.mjs`](tailwind.config.mjs) — **`shadow-soft`** / **`shadow-softSm`** hierarchijos korekcija (kortelės lengvesnės, „pakeltas“ sluoksnis aiškesnis). Atnaujinta [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md) (`.section-shell`, Hero H1, Solution dekoratyvus fonas, šešėliai, checklist, Final Cta stiklo blokas).
- **Landing — mikrodizainas (sekcijos ir copy):** [`Hero.astro`](src/components/sections/Hero.astro) — kairysis stulpelis **`space-y-7 md:space-y-8`**, H1 **`max-w-[20ch] md:max-w-[24ch]`**, **`md:leading-snug`**, dešinės tekstūros opacity šiek tiek sumažinta; [`Solution.astro`](src/components/sections/Solution.astro) — **`space-y-10 md:space-y-12`**, punktų sąrašas **`space-y-2.5`**, **`relative overflow-hidden`** ir dekoratyvus **`bg-diagram-glow`** (`opacity-40`); [`Offers.astro`](src/components/sections/Offers.astro) — **`space-y-10 md:space-y-12`**, sąrašas **`space-y-3.5`**; [`Process.astro`](src/components/sections/Process.astro) — H2 + **`.section-intro`** (`messages.process.intro`), desktop tinklelis **`md:gap-8`**; [`FinalCta.astro`](src/components/sections/FinalCta.astro) — kontaktų kortelė **`border-white/12`**, **`p-6 md:p-7`**.
- **Copy (i18n LT + EN adaptacija):** [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — **`process.intro`** sutrumpintas; **`offers.subtitle`** (kasdienė komunikacijos palaikymas, krizių valdymo strategijos; EN atitinkamai); **`solution.pillars`** — po tris punktus kiekviename stulpelyje, atnaujinti outcome (pvz. „Tvarus augimas“), EN natūrali adaptacija.
- **Brand mėlynos darna ir tipografijos skalė:** [`tailwind.config.mjs`](tailwind.config.mjs) — `diagramElectric` sutapdinta su `accent`; `bg-hero-premium` ir `bg-diagram-glow` baigiasi silpnu tuo pačiu `accent` RGB (be atskiros indigo); sekcijos [`Hero.astro`](src/components/sections/Hero.astro), [`Solution.astro`](src/components/sections/Solution.astro), [`Process.astro`](src/components/sections/Process.astro), [`Offers.astro`](src/components/sections/Offers.astro), [`About.astro`](src/components/sections/About.astro), [`FinalCta.astro`](src/components/sections/FinalCta.astro) — **`.section-intro`** / **`.card-title`**, sąrašai ir proceso aprašymai **`text-base`**, Solution stulpelių outcome — **`text-accent`** (vietoj `accentTeal`). Dokumentacija: [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/BRAND.md`](docs/BRAND.md).
- **Offers — paslaugų paketai:** [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — sekcija „Paslaugų paketai“ / „Service packages“; trys paketai: Startas / Palaikymas / Krizių valdymas (EN: Starter / Ongoing support / Crisis management), `highlighted` ant Palaikymas. Dokumentacija: [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md), [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md) §4.1.
- **Landing — pašalintos sekcijos Problema ir Chaos vs system:** [`LandingPage.astro`](src/components/LandingPage.astro) neberenderina šių blokų (komponentų failai pašalinti); i18n [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — išmesti `problem`, `chaosVsSystem`, `nav.problem`. Sinchronizuota: [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md), [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md), [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md), [`.cursor/rules/intuit-landing.mdc`](.cursor/rules/intuit-landing.mdc), [`src/styles/global.css`](src/styles/global.css).
- **TrustedBy — grid „deck“:** [`src/components/sections/TrustedBy.astro`](src/components/sections/TrustedBy.astro) — responsive CSS grid (2 / 3 / 4 stulpeliai), semantinis `<ul>` / `<li>`, be horizontalaus slankiklio ir kraštų gradientų; i18n [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts): `logosRegionAriaLabel` (vietoj `scrollAriaLabel`), `hint` tuščias — hint eilutė nerodoma. Dokumentacija: [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md), [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md), [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md).
- **Footer — be „Apie“ nuorodos:** [`src/components/Footer.astro`](src/components/Footer.astro) — lieka tik antrinė nuoroda į `#contact` (`nav.contact`); „Apie“ į `#about` iš footerio pašalinta. [docs/COPY-GLOSSARY.md](docs/COPY-GLOSSARY.md) §6.
- **Hero — valdymo diagrama tik Proof:** [`src/components/sections/Hero.astro`](src/components/sections/Hero.astro) — pašalinta dubliuojanti [`HeroSystemDiagram.astro`](src/components/HeroSystemDiagram.astro) (buvo įdėta su `size="hero"` po „svorio“ iteracijos); komunikacijos valdymo schema rodoma vienoje vietoje — [`Proof.astro`](src/components/sections/Proof.astro) su `size="proof"`. Atnaujinta dokumentacija: [`README.md`](README.md), [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md), [`todo.md`](todo.md).
...
- **Proof sekcija („Rodikliai…“ + valdymo diagrama):** pašalinta iš [`LandingPage.astro`](src/components/LandingPage.astro); ištrintas [`Proof.astro`](src/components/sections/Proof.astro); i18n — pašalintas `messages.proof`, `nav.proof`; inverse `<img alt>` perkeltas į `messages.hero.brandPatternAlt`. [`HeroSystemDiagram.astro`](src/components/HeroSystemDiagram.astro) paliktas repozitorijoje (šiuo metu neimportuojamas). Dokumentacija: [`docs/PRD-one-page-PR-AI.md`](docs/PRD-one-page-PR-AI.md), [`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md), [`docs/MOBILE-AUDIT.md`](docs/MOBILE-AUDIT.md), [`docs/COPY-GLOSSARY.md`](docs/COPY-GLOSSARY.md), [`.cursor/rules/intuit-landing.mdc`](.cursor/rules/intuit-landing.mdc), [`README.md`](README.md), [`todo.md`](todo.md).
- **Kontaktai — Prompt Anatomy („Made with PA“):** [`src/components/sections/FinalCta.astro`](src/components/sections/FinalCta.astro) — pašalinta išorinė nuoroda į `promptanatomy.app`; i18n [`src/i18n/lt.ts`](src/i18n/lt.ts) / [`src/i18n/en.ts`](src/i18n/en.ts) — pašalintas `finalCta.madeWithPaLabel`.
